...
def test1():
    ...
    print(f"Impresión decorada: {pretty_print(beverage_T1.get_description())}")  
    print("-----------------")

    # testeo el condimento caramelo Un Espresso simple (1.99), con caramelo (0.20) y Crema (0.10).
    beverage_T1 = Espresso("Tall")
...
#    print(f"Impresión decorada: {beverage_T5.pretty_print()}")  
    print(f"Impresión decorada: {pretty_print(beverage_T5.get_description())}") 
    print("-----------------")


def test6():
    # testeo en el HouseBlend  (0.89), tamaño Grande con soja x2(0.15x2).
    beverage_T6 = HouseBlend("Grande")
...
#    print(f"Impresión decorada: {beverage_T6.pretty_print()}")  
    print(f"Impresión decorada: {pretty_print(beverage_T6.get_description())}") 
    print("-----------------")


def test7():
    # testeo en el HouseBlend  (0.89), tamaño Venti con soja x2(0.20x2).
    beverage_T7 = HouseBlend("Venti")
...
#    print(f"Impresión decorada: {beverage_T7.pretty_print()}")  
    print(f"Impresión decorada: {pretty_print(beverage_T7.get_description())}") 
    print("-----------------")


def test8():
    # testeo en el Decaf  (1.05), tamaño Venti con soja x2(0.20x2) + crema (0.10)) + caramel (0.2).
    beverage_T8 = Decaf("Venti")
...
#    print(f"Impresión decorada: {beverage_T8.pretty_print()}")  
    print(f"Impresión decorada: {pretty_print(beverage_T8.get_description())}") 
    print("-----------------")


def test9():
    # testeo en el Espresso simple  (1.99), tamaño Venti no deberia cambiar el importe
    beverage_T9 = Espresso("Venti")
    print(
...
#    print(f"Impresión decorada: {beverage_T9.pretty_print()}")  
    print(f"Impresión decorada: {pretty_print(beverage_T9.get_description())}") 
    print("-----------------")
...
#    print(f"Impresión decorada: {beverage.pretty_print()}")
    print(f"Impresión decorada: {pretty_print(beverage.get_description())}") 
    print("-----------------")    
